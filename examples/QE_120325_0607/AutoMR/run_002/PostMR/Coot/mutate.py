...
imol = coot.handle_read_draw_molecule("/Users/karolwoloszyn/Documents/GitHub/NASolve/examples/QE_120325_0607/AutoMR/run_002/PostMR/Model/mr_solution.pdb")
if imol < 0:
...
coot.write_pdb_file(imol, "/Users/karolwoloszyn/Documents/GitHub/NASolve/examples/QE_120325_0607/AutoMR/run_002/PostMR/Coot/parent_A_12_DG.pdb")
...
status = coot.mutate_base(imol, 'B', 4, '', 'DT')
print('NASOLVE_PARENT_MUTATE', 'B:4', 'DT', status)
if status != 1:
    raise RuntimeError('Coot parent mutation failed at B:4')
coot.write_pdb_file(imol, "/Users/karolwoloszyn/Documents/GitHub/NASolve/examples/QE_120325_0607/AutoMR/run_002/PostMR/Coot/parent_B_4_DT.pdb")
...
coot.write_pdb_file(imol, "/Users/karolwoloszyn/Documents/GitHub/NASolve/examples/QE_120325_0607/AutoMR/run_002/PostMR/Model/after_coot_raw.pdb")
